        ...
        >
          <Container>
            <m.div variants={fade}>
              ...
              <p className="bg-gray-800 rounded-xl p-4 md:p-6 mb-10 text-lg">As the brand direction was focused on a younger audience, the UI needed to be updated to reflect this. This meant researching competitors UI.</p>
              ...
              <p className="bg-gray-800 rounded-xl p-4 md:p-6 mb-10 text-lg">Shown here are the north face and patagonia site homepage. Both use a neutral colour palette for UI components and use white space effectively for spacing between sections. This approach allows the imagery and content to be the focal point. This approach can also be seen on products such as instagram and depop.</p>
              ...
              <p className="bg-gray-800 rounded-xl p-4 md:p-6 mb-10 text-lg">As part of the new brand direction, instagram influencers specialising in beautiful outdoor imagery were commissioned to photograph burghaus products in the northern English countryside. To showcase this I designed a carousel that could show the images in full width view, with an added feature that showcases the products in the image with links to the products description page.</p>
              ...
              <p className="bg-gray-800 rounded-xl p-4 md:p-6 mb-2 mt-4 text-lg">Comparing the implemented design change to the same time 9 weeks after Launch:</p>
              
              <div className="md:flex flex-row pb-8 bg-gray-800 rounded-xl p-4 md:p-6 mb-10 text-lg">
                <div className="md:basis-1/2 md:pr-1">
              ...
              <p className="bg-gray-800 rounded-xl p-4 md:p-6 my-8 italic">This work was created at &amp; is property of Pentland Brands.</p>
