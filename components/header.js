    ...
    <header className="">
      <Container>
        <div className="flex flex-wrap bg-gray-800 p-4 md:p-6 rounded-md my-4">
          <a href="/" className="text-xl mb-1 md:mb-0 font-bold hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-green-600 hover:to-blue-400 transition ease-in-out delay-100 duration-200">Jonathan Gill : UI/UX Designer</a>
